...
//  IEProject
//
//  Created by Soroush Fathi on 2/4/20.
...
extension RPicker: UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(_ pickerView: UIPickerView, viewForRow row: Int, forComponent component: Int, reusing view: UIView?) -> UIView {
        ...
        label.font = UIFont(name: "IRANSansMobile(FaNum)", size: 18)
...
class RToolBar: UIView {
    ...
    var title = "" {
        didSet {
            ...
            toolBarTitleItem.label.font = UIFont(name: "IRANSansMobile(FaNum)", size: 14)
        }
    }
...
extension UIWindow {
    ...
    static var currentController: UIViewController? {
        return UIApplication.shared.keyWindow?.currentController
    }
